...
class Turkce extends StatefulWidget {
  @override
  _TurkceState createState() => _TurkceState();
}
        ...
        return Form(
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: <Widget>[
                Text('$turkce',style: TextStyle(fontSize: 22.0),),
                SizedBox(height: 25.0,),
                TextFormField(
                  controller: _clearControl,
                  decoration: InputDecoration(
                    hintText: 'İngilizcesini Yazınız',
